        ...
        >
              <View style={styles.card}>
                    ...
                    <AppText size={16} weight="800" color={Colors.PRIMARY} style={styles.sectionTitle}>
                        {t('terms_user_accounts_title') || '1. User Accounts'}
                    </AppText>
                    <AppText size={14} color={Colors.PRIMARY} weight="500" style={styles.paragraph}>
                        {t('terms_user_accounts_desc') || 'When creating an account, you must provide accurate, complete, and current information. You are solely responsible for safeguarding the credentials you use to access the service.'}
                    </AppText>

                    <AppText size={16} weight="800" color={Colors.PRIMARY} style={styles.sectionTitle}>
                        {t('terms_booking_payments_title') || '2. Booking & Payments'}
                    </AppText>
                    <AppText size={14} color={Colors.PRIMARY} weight="500" style={styles.paragraph}>
                        {t('terms_booking_payments_desc') || 'All tickets purchased through the app are subject to availability. Prices and ticket options may vary. You agree to pay all charges incurred at the prices in effect when your payment is initiated.'}
                    </AppText>
